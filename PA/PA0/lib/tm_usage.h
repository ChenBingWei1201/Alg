...
//     cout <<"user time: " << stat.uTime / 1000000.0 << "s" << endl; // print
//     period user time in seconds cout <<"system time: " << stat.sTime /
//     1000000.0 << "s" << endl; // print period systemtime in seconds cout
//     <<"user+system time:" << (stat.uTime + stat.sTime) / 1000000.0 << "s" <<
//     endl;
//
//     // do something...
//
